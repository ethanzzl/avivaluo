...
export const projectCatalog: Project[] = [
  ...
  },
  {
    ...
    cover: artwork(
      ...
      2224,
      "戴眼镜的伴侣双人肖像",
      "Portrait of a couple wearing glasses",
    ),
    gallery: [
      ...
      artwork("portraits-family", "A33", 1697, 2400, "多组人物表情与造型的肖像研究", "Portrait studies exploring varied faces and character shapes"),
